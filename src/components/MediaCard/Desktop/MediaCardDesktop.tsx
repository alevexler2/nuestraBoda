...
const MediaCardDesktop = ({ subtitle, imageUrl, cardRef, mediaType, owner, onDelete, showAlertModal, setShowAlertModal, handleDelete, isLoading, handleLike, likesCount, isLikedByUser, handleShowComments, viewComments, value, setValue, handleSendComment, renderComments, comments }: MediaCardInterface) => {
